              ...
              if($res)
              {
                // if( $fonction==='professeur'){
                  echo "<div class='sucess'>
                        ...
                        <p> Pour plus de sécurité , veuillez cliquez ici pour valider votre profil <a href='validconnexion'>SE connecter </a></p>
                  </div>";

                // } else if($fonction==='etudiant'){
                //   echo "<div class='sucess'>
                //     <h3>Vous êtes inscrit avec succès.</h3>
                //     <p> Pour plus de sécurité , veuillez cliquez ici pour valider votre profil <a href='validconnexion'>toto </a></p>
                //   </div>";
