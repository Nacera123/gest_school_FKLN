...
<div class="header">
   ...
   <h5><b> Collège René Descartes - 74 avenue Gilbert Berger 75015 Paris - 01 48 44 41 01 </b></h5>
...
<div class="d-flex justify-content-center">
  ...
  <div class="card text-dark bg-light mb-3" style="max-width: 25rem;">
    <div class="card-header">identifiez-vous</div>
      <div class="card-body">
        <p class="card-text">
          <form class="box" action="" method="post" name="login">
            ...
            <p class="box-register">Vous n'avez pas encore un compte ?<a href="register.tpl.html">S'inscrire</a></p>
          </form>
        </p>
      </div>
    </div>
...
<!----------------------------------------Un peu de Style pour faire jolie                                             -->
